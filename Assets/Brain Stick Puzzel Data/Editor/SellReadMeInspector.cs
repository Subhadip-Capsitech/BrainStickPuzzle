...
public class SellReadMeInspector : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.LabelField("1. Game Documentation", EditorStyles.boldLabel);

        if (GUILayout.Button("Open Online Documentation", GUILayout.MinHeight(40)))
        {
            Application.OpenURL("https://drive.google.com/open?id=1dGE3N_z_giemmgpitdhGStRYJ0mu8ilL_vBTN0v5miE");
        }
        ...
        EditorGUILayout.Space();
        if (GUILayout.Button("How to make more levels", GUILayout.MinHeight(40)))
        {
            Application.OpenURL("https://youtu.be/7u-wBuUrLkM");
        }

        EditorGUILayout.Space();

        EditorGUILayout.LabelField("2. My Other Great Source Codes", EditorStyles.boldLabel);
